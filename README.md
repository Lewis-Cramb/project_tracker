...
[commit num] - Sixth commit, added the scanner to test input (this may be removed when gui is implemented but is here to test for now) ; I used https://www.w3schools.com/java/java_user_input.asp to learn scanner from